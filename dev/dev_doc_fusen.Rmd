...
```{r tests-render_prettyprint}
test_that("render_prettyprint works", {
  expect_true(inherits(render_prettyprint, "function")) 
})
```
...
```{r function-app_prettyprint}
#' Shiny Interface for {XlsFormPrettyPrint} pretty output
#' 
#' This builds on the template and function
#' 
#' @importFrom shiny shinyApp withProgress 
#'               tabsetPanel fileInput tabPanelBody
   ...
   # includeCSS(path = "styles.css"),
      tags$div(
        class = "main_page_content",
          tags$h1(
            tags$strong("{XlsFormPrettyPrint}",
              style = "font-size: 100%;
                       padding-bottom: 0%;"
            )
          ),
        tags$div(
          ...
          tags$h4(
            HTML(
                '<br><br>Welcome to <b>{XlsFormPrettyPrint}</b>! This is an app to convert ODK/Kobo survey forms to printable, 
                ...
                target="_blank"> settings</b></span></a> sheet. 
                
                An example form, with the names required for using this app, can be found <b><span class="half_background"> <a href = "https://docs.google.com/spreadsheets/d/1tUPkbjIv0H2Aoj78kCf0eMAQO-uALoMIEJq4aL1C00I/edit#gid=0", 
        ...
        tags$div(
          tags$h3(
          HTML(
            '<b> Note:</b> Please report bugs and share suggestions as <a href = "https://github.com/edouard-legoupil/XlsFormPrettyPrint/issues", target="_blank">issues</a> ! (<b>v2</b>).'
          ),
      ...
      tags$div(
        tags$h2(
          HTML(
            ' 
            <i class="fa fa-github" style = "color: #8e8d8d;"></i> 
            <a href = "https://edouard-legoupil.github.io/XlsFormPrettyPrint/", target="_blank">XlsFormPrettyPrint</span></a>'
          ),
          style          = "font-size: 10px;
                            width: 460px;
                            text-align: center;
...
```{r tests-app_prettyprint}
test_that("app_prettyprint works", {
  expect_true(inherits(app_prettyprint, "function")) 
})
```
